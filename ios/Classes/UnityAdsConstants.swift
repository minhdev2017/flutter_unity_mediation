struct UnityAdsConstants {
    ...
    static let REWARD_ID_PARAMETER = "rewardId";
    static let FULL_ID_PARAMETER = "fullId";
    ...
    static let SHOW_FULL_METHOD = "showFull";
    static let SHOW_REWARD_METHOD = "showReward";
